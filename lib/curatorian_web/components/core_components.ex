defmodule CuratorianWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CuratorianWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CuratorianWeb.Gettext, "errors", msg, opts)
    end
  end
