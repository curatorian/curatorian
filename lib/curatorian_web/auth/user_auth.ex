defmodule CuratorianWeb.UserAuth do
  ...
  alias Curatorian.Accounts.Scope

  # Make the remember me cookie valid for 14 days. This should match
  # the session validity setting in UserToken.
  @max_cookie_age_in_days 14
  @remember_me_cookie "_newver_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  the `current_scope`:
      ...
      defmodule CuratorianWeb.PageLive do
        ...
        on_mount {CuratorianWeb.UserAuth, :mount_current_scope}
        ...
      end
  ...
  def on_mount(:ensure_user_is_manager, _params, session, socket) do
    ...
    if socket.assigns.current_scope && socket.assigns.current_scope.user &&
         socket.assigns.current_scope.user.user_role == "manager" do
      {:cont, socket}
    else
      socket =
        socket
