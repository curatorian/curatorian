...
vocab = [
  ...
  %{
    ...
    information: "DCMI Metadata Terms — extended Dublin Core (ISO 15836). Base descriptive layer for all GLAM sectors."
  },
  %{
    namespace_url: "http://purl.org/dc/dcmitype/",
    prefix: "dctype",
    label: "Dublin Core Type",
    information: "DCMI Type Vocabulary — controlled list of resource types (Collection, Dataset, Event, Image, etc.)."
  },
  %{
  ...
  %{
    ...
    information: "FOAF — relationships between people and organisations. Used for agent description across GLAM."
  },
...
properties_list = [
  ...
  %{owner_id: nil, vocabulary_id: 1, local_name: "title",
    label: "Title", comment: "A name given to the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "creator",
    label: "Creator", comment: "An entity primarily responsible for making the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "subject",
    label: "Subject", comment: "The topic of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "description",
    label: "Description", comment: "An account of the resource.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "publisher",
    label: "Publisher", comment: "An entity responsible for making the resource available.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "contributor",
    label: "Contributor", comment: "An entity responsible for making contributions to the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "date",
    label: "Date", comment: "A point or period of time associated with an event in the lifecycle of the resource.", type_value: "date"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "type",
    label: "Type", comment: "The nature or genre of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "format",
    label: "Format", comment: "The file format, physical medium, or dimensions of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "identifier",
    label: "Identifier", comment: "An unambiguous reference to the resource within a given context.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "source",
    label: "Source", comment: "A related resource from which the described resource is derived.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "language",
    label: "Language", comment: "A language of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "relation",
    label: "Relation", comment: "A related resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "coverage",
    label: "Coverage", comment: "The spatial or temporal topic of the resource, spatial applicability, or jurisdiction.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "rights",
    label: "Rights", comment: "Information about rights held in and over the resource.", type_value: "textarea"},
  # Extended dcterms
  %{owner_id: nil, vocabulary_id: 1, local_name: "abstract",
    label: "Abstract", comment: "A summary of the resource.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "accessRights",
    label: "Access Rights", comment: "Information about who can access the resource or an indication of its security status.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "accrualMethod",
    label: "Accrual Method", comment: "The method by which items are added to a collection.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "accrualPeriodicity",
    label: "Accrual Periodicity", comment: "The frequency with which items are added to a collection.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "alternative",
    label: "Alternative Title", comment: "An alternative name for the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "audience",
    label: "Audience", comment: "A class of entity for whom the resource is intended or useful.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "bibliographicCitation",
    label: "Bibliographic Citation", comment: "A bibliographic reference for the resource.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "conformsTo",
    label: "Conforms To", comment: "An established standard to which the described resource conforms.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "created",
    label: "Date Created", comment: "Date of creation of the resource.", type_value: "date"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "extent",
    label: "Extent", comment: "The size or duration of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "hasFormat",
    label: "Has Format", comment: "A related resource that is substantially the same as the pre-existing described resource, but in another format.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "hasPart",
    label: "Has Part", comment: "A related resource that is included either physically or logically in the described resource.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "hasVersion",
    label: "Has Version", comment: "A related resource that is a version, edition, or adaptation of the described resource.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "isFormatOf",
    label: "Is Format Of", comment: "A related resource that is substantially the same as the described resource, but in another format.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "isPartOf",
    label: "Is Part Of", comment: "A related resource in which the described resource is physically or logically included.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "isReferencedBy",
    label: "Is Referenced By", comment: "A related resource that references, cites, or otherwise points to the described resource.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "isReplacedBy",
    label: "Is Replaced By", comment: "A related resource that supplants, displaces, or supersedes the described resource.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "isVersionOf",
    label: "Is Version Of", comment: "A related resource of which the described resource is a version, edition, or adaptation.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "issued",
    label: "Date Issued", comment: "Date of formal issuance of the resource.", type_value: "date"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "license",
    label: "License", comment: "A legal document giving official permission to do something with the resource.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "mediator",
    label: "Mediator", comment: "An entity that mediates access to the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "medium",
    label: "Medium", comment: "The material or physical carrier of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "modified",
    label: "Date Modified", comment: "Date on which the resource was changed.", type_value: "date"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "provenance",
    label: "Provenance", comment: "A statement of any changes in ownership and custody of the resource since its creation.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "references",
    label: "References", comment: "A related resource that is referenced, cited, or otherwise pointed to by the described resource.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "replaces",
    label: "Replaces", comment: "A related resource that is supplanted, displaced, or superseded by the described resource.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "requires",
    label: "Requires", comment: "A related resource that is required by the described resource to support its function.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "rightsHolder",
    label: "Rights Holder", comment: "A person or organisation owning or managing rights over the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "spatial",
    label: "Spatial Coverage", comment: "Spatial characteristics of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "tableOfContents",
    label: "Table Of Contents", comment: "A list of subunits of the resource.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "temporal",
    label: "Temporal Coverage", comment: "Temporal characteristics of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 1, local_name: "valid",
    label: "Date Valid", comment: "Date (often a range) of validity of a resource.", type_value: "date"},

  # ── 2. Dublin Core Type (dctype) ─────────────────────────────────────────────
  %{owner_id: nil, vocabulary_id: 2, local_name: "Collection",
    label: "Collection", comment: "An aggregation of resources.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "Dataset",
    label: "Dataset", comment: "Data encoded in a defined structure.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "Event",
    label: "Event", comment: "A non-persistent, time-based occurrence.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "Image",
    label: "Image", comment: "A visual representation other than text.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "InteractiveResource",
    label: "Interactive Resource", comment: "A resource requiring interaction from the user to be understood, executed, or experienced.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "MovingImage",
    label: "Moving Image", comment: "A series of visual representations imparting an impression of motion.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "PhysicalObject",
    label: "Physical Object", comment: "An inanimate, three-dimensional object or substance.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "Service",
    label: "Service", comment: "A system that provides one or more functions.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "Software",
    label: "Software", comment: "A computer program in source or compiled form.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "Sound",
    label: "Sound", comment: "A resource primarily intended to be heard.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "StillImage",
    label: "Still Image", comment: "A static visual representation.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 2, local_name: "Text",
    label: "Text", comment: "A resource consisting primarily of words for reading.", type_value: "text"},

  # ── 3. Bibliographic Ontology (bibo) ─────────────────────────────────────────
  %{owner_id: nil, vocabulary_id: 3, local_name: "affirmedBy",
    label: "Affirmed By", comment: "A legal decision that affirms a ruling.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "annotates",
    label: "Annotates", comment: "Critical or explanatory note for a Document.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "authorList",
    label: "Author List", comment: "An ordered list of authors. Priority list that orders authors by importance.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "chapter",
    label: "Chapter", comment: "An chapter number.", type_value: "integer"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "edition",
    label: "Edition", comment: "The name defining a publishing iteration of a book.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "editorList",
    label: "Editor List", comment: "An ordered list of editors.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "handle",
    label: "Handle", comment: "A handle for the resource (persistent URL).", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "isbn10",
    label: "ISBN-10", comment: "The International Standard Book Number (10-digit).", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "isbn13",
    label: "ISBN-13", comment: "The International Standard Book Number (13-digit).", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "issn",
    label: "ISSN", comment: "The International Standard Serial Number.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "issue",
    label: "Issue", comment: "An issue number of a journal, magazine, or newspaper.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "numPages",
    label: "Number of Pages", comment: "The number of pages contained in a document.", type_value: "integer"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "numVolumes",
    label: "Number of Volumes", comment: "The number of volumes of a multi-volume book.", type_value: "integer"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "pageEnd",
    label: "Page End", comment: "Ending page number within a continuous page range.", type_value: "integer"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "pageStart",
    label: "Page Start", comment: "Starting page number within a continuous page range.", type_value: "integer"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "pages",
    label: "Pages", comment: "A string of non-contiguous page spans that locate a document within a larger document.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "prefixName",
    label: "Prefix Name", comment: "The prefix of a name (e.g., Dr., Professor).", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "shortTitle",
    label: "Short Title", comment: "The abbreviated title of the resource.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "suffixName",
    label: "Suffix Name", comment: "The suffix of a name (e.g., Jr., Sr., III).", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "uri",
    label: "URI", comment: "Universal Resource Identifier of a document.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 3, local_name: "volume",
    label: "Volume", comment: "A volume number.", type_value: "text"},

  # ── 4. FOAF ───────────────────────────────────────────────────────────────────
  %{owner_id: nil, vocabulary_id: 4, local_name: "name",
    label: "Name", comment: "A name for the thing.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "firstName",
    label: "First Name", comment: "The first name of a person.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "lastName",
    label: "Last Name", comment: "The last name of a person.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "title",
    label: "Title", comment: "A title (Mr, Mrs, Dr, etc.).", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "mbox",
    label: "Email", comment: "A personal mailbox of the person.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "homepage",
    label: "Homepage", comment: "A homepage for the person or organisation.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "depiction",
    label: "Depiction", comment: "A depiction (image) of the person or thing.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "organization",
    label: "Organization", comment: "An organisation to which the agent is affiliated.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "knows",
    label: "Knows", comment: "A person known by this agent.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "member",
    label: "Member", comment: "Indicates a member of a Group.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "based_near",
    label: "Based Near", comment: "A location that something is based near.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 4, local_name: "topic_interest",
    label: "Topic of Interest", comment: "A topic of interest for this person.", type_value: "text"},

  # ── 5. VRA Core 4.0 ──────────────────────────────────────────────────────────
  %{owner_id: nil, vocabulary_id: 5, local_name: "agent",
  ...
  %{owner_id: nil, vocabulary_id: 5, local_name: "culturalContext",
  ...
  %{owner_id: nil, vocabulary_id: 5, local_name: "date",
  ...
  %{owner_id: nil, vocabulary_id: 5, local_name: "description",
    label: "Description", comment: "A free-text description of the work, image, or collection.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 5, local_name: "inscription",
  ...
  %{owner_id: nil, vocabulary_id: 5, local_name: "location",
  ...
  %{owner_id: nil, vocabulary_id: 5, local_name: "subject",
  ...
  %{owner_id: nil, vocabulary_id: 5, local_name: "title",
    label: "Title", comment: "The title or identifying phrase given to a work.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 5, local_name: "worktype",
  ...
  %{owner_id: nil, vocabulary_id: 10, local_name: "artMedium",
  ...
  %{owner_id: nil, vocabulary_id: 10, local_name: "artform",
  ...
  %{owner_id: nil, vocabulary_id: 11, local_name: "controlNumberIdentifier",
  ...
  %{owner_id: nil, vocabulary_id: 11, local_name: "latestTransactionDateTime",
    label: "Latest Transaction Date/Time (005)", comment: "Date and time of the latest record transaction.", type_value: "date"},
  %{owner_id: nil, vocabulary_id: 11, local_name: "fixedLengthDataElements",
  ...
  %{owner_id: nil, vocabulary_id: 11, local_name: "corporateName",
    label: "Corporate Name — Main Entry (110)", comment: "Corporate name as the main entry for the record.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 11, local_name: "uniformTitle",
  ...
  %{owner_id: nil, vocabulary_id: 11, local_name: "physicalDescription",
  ...
  %{owner_id: nil, vocabulary_id: 11, local_name: "generalNote",
  ...
  # ── 12. MODS ───────────────────────────────────────────────────────────────────
  %{owner_id: nil, vocabulary_id: 12, local_name: "titleInfo",
  ...
  %{owner_id: nil, vocabulary_id: 12, local_name: "genre",
  ...
  %{owner_id: nil, vocabulary_id: 12, local_name: "location",
  ...
  %{owner_id: nil, vocabulary_id: 13, local_name: "contribution",
  ...
  %{owner_id: nil, vocabulary_id: 13, local_name: "content",
    label: "Content Type", comment: "Content type of the Work (RDA Content Type term).", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 13, local_name: "summary",
  ...
  %{owner_id: nil, vocabulary_id: 14, local_name: "fileSec",
    label: "File Section", comment: "Inventory of files comprising the digital object.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 14, local_name: "structMap",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "extentAndMedium",
    label: "Extent and Medium", comment: "Physical extent and medium of the unit of description.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 16, local_name: "nameOfCreator",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "administrativeHistory",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "archivalHistory",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "immediateSourceOfAcquisition",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "scopeAndContent",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "appraisalDestructionScheduling",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "accruals",
    label: "Accruals", comment: "Planned additions to the unit of description.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 16, local_name: "systemOfArrangement",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "conditionsGoverningAccess",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "conditionsGoverningReproduction",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "languageScriptsOfMaterial",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "physicalTechnicalRequirements",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "findingAids",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "existenceAndLocationOfOriginals",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "existenceAndLocationOfCopies",
    label: "Existence and Location of Copies", comment: "Information about copies of the unit of description.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 16, local_name: "relatedUnitsOfDescription",
  ...
  %{owner_id: nil, vocabulary_id: 16, local_name: "publicationNote",
  ...
  %{owner_id: nil, vocabulary_id: 17, local_name: "bioghist",
  ...
  %{owner_id: nil, vocabulary_id: 17, local_name: "arrangement",
    label: "Arrangement", comment: "Information about the arrangement of the materials.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 17, local_name: "accessrestrict",
  ...
  %{owner_id: nil, vocabulary_id: 18, local_name: "structureOrGenealogy",
  ...
  %{owner_id: nil, vocabulary_id: 20, local_name: "objectCategory",
  ...
  %{owner_id: nil, vocabulary_id: 20, local_name: "preservationLevel",
  ...
  %{owner_id: nil, vocabulary_id: 20, local_name: "significantProperties",
  ...
  %{owner_id: nil, vocabulary_id: 20, local_name: "eventDateTime",
  ...
  %{owner_id: nil, vocabulary_id: 21, local_name: "datesOfExistence",
    label: "Dates of Existence", comment: "Dates of existence of the corporate body, person, or family.", type_value: "date"},
  %{owner_id: nil, vocabulary_id: 21, local_name: "history",
    label: "History", comment: "A concise history of the corporate body, person, or family.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 21, local_name: "places",
    label: "Places", comment: "Significant places associated with the entity.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 21, local_name: "legalStatus",
    label: "Legal Status", comment: "Legal status of a corporate body.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 21, local_name: "functions",
    label: "Functions", comment: "Functions, occupations and activities of the entity.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 21, local_name: "mandatesOrSources",
  ...
  %{owner_id: nil, vocabulary_id: 21, local_name: "internalStructure",
  ...
  %{owner_id: nil, vocabulary_id: 21, local_name: "generalContext",
  ...
  %{owner_id: nil, vocabulary_id: 21, local_name: "relatedCorporateBodies",
  ...
  %{owner_id: nil, vocabulary_id: 23, local_name: "loanInDetails",
  ...
  %{owner_id: nil, vocabulary_id: 23, local_name: "loanOutDetails",
  ...
  %{owner_id: nil, vocabulary_id: 23, local_name: "movementDetails",
  ...
  %{owner_id: nil, vocabulary_id: 25, local_name: "materialsAndTechniques",
  ...
  %{owner_id: nil, vocabulary_id: 25, local_name: "measurements",
    label: "Measurements", comment: "The dimensions and/or weight of the object.", type_value: "text"},
  %{owner_id: nil, vocabulary_id: 25, local_name: "inscriptionsAndMarkings",
  ...
  %{owner_id: nil, vocabulary_id: 25, local_name: "distinguishingFeatures",
  ...
  %{owner_id: nil, vocabulary_id: 25, local_name: "titleOrSubject",
  ...
  %{owner_id: nil, vocabulary_id: 27, local_name: "inScheme",
    label: "In Scheme", comment: "Relates a resource to the concept scheme of which it is part.", type_value: "uri"},
  %{owner_id: nil, vocabulary_id: 27, local_name: "hasTopConcept",
  ...
  %{owner_id: nil, vocabulary_id: 28, local_name: "metadata",
    label: "Metadata", comment: "An ordered list of label/value pairs for display to the user.", type_value: "textarea"},
  %{owner_id: nil, vocabulary_id: 28, local_name: "requiredStatement",
