defmodule CuratorianWeb.Public.Tools.Museum.IndexLive do
  ...
  @tools [
    %{
      id: "museum-base",
      title: "Alat Museum",
      description: "Katalog walk-through, pameran, dan metadata koleksi (segera hadir).",
      path: "#",
      status: "soon"
    }
  ]
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Tools Museum", tools: @tools)}
  end
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="max-w-6xl mx-auto py-8 px-4">
        <div class="mb-6">
          <h1 class="text-3xl sm:text-4xl font-bold">Museum</h1>
          <p class="text-base text-base-content/70">
            Semua fitur museum akan tersedia di sini. Untuk saat ini, lihat bagian “Akan Datang”.
          </p>
