defmodule CuratorianWeb.Public.Tools.Archive.IndexLive do
  ...
  @tools [
    %{
      id: "archive-base",
      title: "Alat Arsip",
      description: "Solusi arsip dan manajemen rekaman (segera hadir).",
      path: "#",
      status: "soon"
    }
  ]
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Tools Arsip", tools: @tools)}
  end
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="max-w-6xl mx-auto py-8 px-4">
        <div class="mb-6">
          <h1 class="text-3xl sm:text-4xl font-bold">Arsip</h1>
          <p class="text-base text-base-content/70">
            Fitur arsip akan ada di sini. Tunggu pembaruan dari tim Curatorian.
          </p>
