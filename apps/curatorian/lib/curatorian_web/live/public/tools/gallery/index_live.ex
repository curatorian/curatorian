defmodule CuratorianWeb.Public.Tools.Gallery.IndexLive do
  ...
  @tools [
    %{
      id: "gallery-base",
      title: "Alat Galeri",
      description: "Manajemen koleksi digital galeri (segera hadir).",
      path: "#",
      status: "soon"
    }
  ]
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Tools Galeri", tools: @tools)}
  end
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="max-w-6xl mx-auto py-8 px-4">
        <div class="mb-6">
          <h1 class="text-3xl sm:text-4xl font-bold">Galeri</h1>
          <p class="text-base text-base-content/70">Penambahan modul galeri sedang dikerjakan.</p>
